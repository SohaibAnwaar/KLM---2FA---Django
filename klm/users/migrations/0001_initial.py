# Generated by Django 4.2.8 on 2024-01-19 11:42

import django.contrib.auth.validators
from django.db import migrations, models
import django.utils.timezone
import klm.users.managers
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "qr_code",
                    models.ImageField(blank=True, null=True, upload_to=klm.users.models.get_qr_code_file_path),
                ),
            ...
            managers=[
                ("objects", klm.users.managers.UserManager()),
            ],
        ),
    ]
